...
class Structure():
    ...
    def __init__(self, dim, lat=None, coords=None, masses=None, atoms=None, ):
        """
        Parameters
        ----------
        dim : int
    ...
    def _atoms_to_masses(self, atoms):
        """
    ...
    @staticmethod    
    def _direct_to_cartesian(coord, lat):
        """
    ...
    def read_supercell(self, sposcar):
        """
